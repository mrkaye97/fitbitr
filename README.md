...
get_activity(token, "steps", date=date, period="7d")
#>     dateTime value
#> 1 2017-12-23 14310
#> 2 2017-12-24 16136
#> 3 2017-12-25 18147
...
df <- get_activity_intraday(token, "steps", date, detail_level="15min")
...
df <- get_heart_rate(token, date=date, period="7d")
...
df <- get_heart_rate_intraday(token, date=date, detail_level="15min")
...
get_sleep(token, "timeInBed", date="2016-04-02", period="7d")
#>     dateTime value
#> 1 2016-03-27     0
#> 2 2016-03-28     0
#> 3 2016-03-29   714
...
#> 6 2016-04-01   326
#> 7 2016-04-02   434
get_sleep(token, "efficiency", base_date="2016-03-30", end_date="2016-03-30")
#>     dateTime value
#> 1 2016-03-30    55
